module Bosh::Cloudfoundry
  ...
  # From this class you can navigate to one or more ReleaseVersionedTemplates (deployment sizes).
  class ReleaseVersionForCpi
    ...
    def self.for_cpi(release_version, cpi)
      ...
      ReleaseVersionForCpi.new(release_version, cpi)
    end
